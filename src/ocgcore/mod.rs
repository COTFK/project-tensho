...
pub use crate::ocgcore::actions::AvailableActions;
...
extern "C" {
    ...
    fn get_wasm_memory(this: &OCGCoreInstance) -> js_sys::WebAssembly::Memory;
...
impl OCGCore {
    ...
    fn get_wasm_memory(&self) -> js_sys::WebAssembly::Memory {
